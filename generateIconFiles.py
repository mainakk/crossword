...
for i in range(1, 100):
  ...
  with open(icons_path, 'wb') as f:
    ...
    code += r'<svg width="40" height="40" xmlns="http://www.w3.org/2000/svg">' + '\n'
    code += r'<text x="0" y="9" font-size="medium">' + bangla.convert_english_digit_to_bangla_digit(str(i)) + r'</text>' + '\n'
    code += r'</svg>'
